...
// CUSTOME COMMON JQUER
    ...
    parallax.holography.onload = function () {
		...
		//$("#holography-cover .page-heading h1").show("slide", { direction: "up" }, 2000);
		//$("#mac").fadeIn(2000);
        /*$(".pds").show();
        $(".cbs").hide();*/
        $(".ps, .jus").show();
	...
	parallax.scaledmodal.onload = function () {
		...
		$('div.inner-content-div').slimScroll({
			color: '#eaeaea',
			size: '5px',
			height: 'auto',
			alwaysVisible: true
...
//3D scaled models & visual presentations JS
	parallax.portfolio.onload = function () {
		...
		var slider = $("#portfolio-slider").sliderTabs({
		 ...
		 $('#portfolio-owlcarousel, #testimonail-owlcarousel').owlCarousel({
        loop:true,
        video:true,
        lazyLoad:true,
       		 autoplay:false,
